...
The colornames provided can be estimated for their valence (positive/negative) of sentiment.  There is a well-established body of work examining color preferences across the color spectrum.  The sentiment of color names may provide complementary insights into humans' preferences for different colors.

```{r sentiment-analyses}
# Get sentiment from sentimentr; this takes a while
